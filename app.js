...
router.post('/login', (req, res) => {
  ...
  // Hardcode phần user-password (file config.js)
  ...
  // Đăng nhập thành công, xoá password ra khỏi payload để không lưu vào token
...
const TokenCheckMiddleware = async (req, res, next) => {
  ...
  //vô hiệu hoá những token còn hiệu lực ở lần start trước
